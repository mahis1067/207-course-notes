...
public class MyHashing {
  ...
  public static int hash(String value) {
    ...
    int sum = 0;
    char[] new_values = value.toCharArray();

    for (char p : new_values) {
      sum = sum + p;    //YOU CAN SUM AN INT AND CHAR, THE CHAR AUTOMATICALLY CHANGES TO ITS INT
    }
    return sum;
  }
}
